...
#pragma HLS ARRAY_PARTITION dim=1 type=complete variable=input_img
	...
	hwmm_layer1(input_img, weightslayer1_weights, temp_output);
	hw_act_layer1(temp_output, temp_output);
	hwmm_layer2(temp_output, weightslayer2_weights, temp_output2);
	hw_act_layer2(temp_output2, temp_output2);
	hwmm_layer3(temp_output2, weightslayer3_weights, temp_output3);
